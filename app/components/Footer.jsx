...
function Footer() {
  ...
  return (
    <nav className='flex flex-row justify-center bg-black  text-center p-5   text-sm    w-full bg-opacity-70'>
      ...
      <svg className="h-14 w-14 ml-12 z-50 hover:h-16 hover:16" clip-rule="evenodd" 
      onClick={goUp}
      fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
