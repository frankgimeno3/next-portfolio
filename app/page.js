    ...
    <div className='mt-8'>
      <div className='relative'>
         <video
          ...
          loop
          muted
          className='object-cover w-full h-full absolute z-0 opacity-30 h-screen'
        >
          <source src="/videos/blue.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </video>
        
         <div className='flex flex-row pr-24 py-10 text-sky-200 pt-16 relative z-10'>
          <div className='flex-1 flex flex-col text-left pl-24 pr-14 mr-10 bg-white bg-opacity-5 pt-10 rounded-r-lg'>
            ...
            <div className='flex flex-row mt-5'>
              <div className=''>
                <button className='py-3 w-40 bg-sky-50 hover:mr-1 text-xs rounded-lg shadow-white hover:scale-110 hover:bg-white text-gray-700 transition-transform duration-1000'>
                  Contact me
                </button>
              </div>
              <div className='mx-2'>
                <button className='py-3 w-40 bg-sky-50 hover:mx-1 text-xs rounded-lg shadow hover:scale-110 hover:bg-white text-gray-700 transition-transform duration-1000'>
                  My Skills
                </button>
              </div>
              <div>
                <button className='py-3 w-40 bg-sky-50 hover:ml-1 text-xs rounded-lg shadow hover:scale-110 hover:bg-white text-gray-700 transition-transform duration-1000'>
                  Portfolio
                </button>
              </div>
            </div>
