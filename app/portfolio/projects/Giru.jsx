...
function Giru() {
   ...
   return (
    <div className='flex flex-row pl-24 py-10 text-sky-200 py-16  '>
        ...
        <Image src={"/projects/giru1.png"} alt='profile i' width={150} height={150} className='mx-auto  justify-center items-center px-auto rounded-lg rounded-lg shadow-lg hover:scale-110 transition-transform duration-1000' />
        <Image src={"/projects/giru2.png"} alt='profile i' width={150} height={150} className='mx-auto  justify-center items-center px-auto rounded-lg rounded-lg shadow-lg hover:scale-110 transition-transform duration-1000' />
        <Image src={"/projects/giru3.png"} alt='profile i' width={150} height={150} className='mx-auto  justify-center items-center px-auto rounded-lg rounded-lg shadow-lg hover:scale-110 transition-transform duration-1000' />
      </div>          </div>
